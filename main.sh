...
srvname="EmetCorp SMP"
srvmotd="Jefe is not allowed - do not feed the troll"
...
eagurl="https://framagit.org/zqpvr/eaglercraft-fork/-/raw/main/stable-download/stable-download_repl.zip?inline=false"
